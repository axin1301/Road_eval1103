...
import sys
import mapcompare_GE_RL3_constructed_single_test
import average_statistics_GE_RL3_constructed

if __name__ == '__main__':

    mapcompare_GE_RL3_constructed_single_test.main()
    # mapcompare_GE_0001.main()
    average_statistics_GE_RL3_constructed.main()